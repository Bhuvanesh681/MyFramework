...
public class DCTQuickQuoteTest4 extends BaseTest{
	SoftAssert softAssert;
	private DCTQuickQuoteTest4() {
	}

	@FrameworkAnnotation(author= {"bhuvanesh"},category= {CategoryType.REGRESSION,CategoryType.SANITY})
	@Test
	public void QuickQuoteFlowTest4(Map<String,String> data) throws InterruptedException {
		...
		.verifyNJPLIGALabel();
		softAssert.assertEquals(test4, true);
