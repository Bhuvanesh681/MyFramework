...
public class DCTQuickQuoteTest5 extends BaseTest{
	private DCTQuickQuoteTest5() {
	}

	@FrameworkAnnotation(author= {"bhuvanesh"},category= {CategoryType.REGRESSION,CategoryType.SANITY})
	@Test
	public void QuickQuoteFlowTest5(Map<String,String> data) throws InterruptedException {
