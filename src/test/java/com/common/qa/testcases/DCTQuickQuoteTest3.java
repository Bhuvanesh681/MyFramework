...
public class DCTQuickQuoteTest3 extends BaseTest{
	private DCTQuickQuoteTest3() {
	}

	@FrameworkAnnotation(author= {"bhuvanesh"},category= {CategoryType.REGRESSION,CategoryType.SANITY})
	@Test
	public void QuickQuoteFlowTest3(Map<String,String> data) throws InterruptedException {
